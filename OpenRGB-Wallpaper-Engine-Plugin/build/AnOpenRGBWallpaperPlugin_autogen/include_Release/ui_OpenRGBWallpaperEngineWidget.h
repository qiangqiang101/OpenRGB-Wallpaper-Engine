...
public:
    ...
    void setupUi(QWidget *OpenRGBWallpaperEngineWidget)
    {
        if (OpenRGBWallpaperEngineWidget->objectName().isEmpty())
            OpenRGBWallpaperEngineWidget->setObjectName(QString::fromUtf8("OpenRGBWallpaperEngineWidget"));
        ...
        detail_box->setObjectName(QString::fromUtf8("detail_box"));
        ...
        port_spin->setObjectName(QString::fromUtf8("port_spin"));
        ...
        aspectLabel->setObjectName(QString::fromUtf8("aspectLabel"));

        formLayout->setWidget(3, QFormLayout::LabelRole, aspectLabel);

        size_combo = new QComboBox(detail_box);
        size_combo->setObjectName(QString::fromUtf8("size_combo"));
        ...
        tier_combo->setObjectName(QString::fromUtf8("tier_combo"));
        ...
        blur_spin->setObjectName(QString::fromUtf8("blur_spin"));
        ...
        radius_spin->setObjectName(QString::fromUtf8("radius_spin"));
        ...
        padding_spin->setObjectName(QString::fromUtf8("padding_spin"));
        ...
        coverLayout->setObjectName(QString::fromUtf8("coverLayout"));
        cover_edit = new QLineEdit(detail_box);
        cover_edit->setObjectName(QString::fromUtf8("cover_edit"));
        ...
        listButtonsLayout->setObjectName(QString::fromUtf8("listButtonsLayout"));
